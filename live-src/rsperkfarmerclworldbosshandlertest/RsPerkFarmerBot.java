 ...
 */
@ScriptManifest(
        name        = "Perk Farmer CL (World-Boss-Handler Test) v1.24",
        author      = "you",
        version     = 1.24,
        uid         = "kreme.rs.perkfarmer.cl.worldbosshandlertest",
...
public class RsPerkFarmerBot extends Script {
    ...
    public void paint(Graphics g) {
        try {
            ...
            try {
                ...
                g2.drawString("Perk Farmer CL (WBH)", PAINT_X + 8, PAINT_Y + 16);
    ...
    private void ensureWindow() {
        ...
        Runnable build = () -> {
            JFrame f = new JFrame("Perk Farmer CL (World-Boss-Handler Test)");
    ...
    public void log(String line) {
        System.out.println("[PerkFarmerCLWorldBossTest] " + line);
