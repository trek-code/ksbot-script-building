...
- Output jar: `D:\Codex GPT\RSPS\KSBOT Script building\handoff\packages\woodcutter-bot-reason-1.3.0.jar`
...
- optionally click `Mark Tree Group`
- click `Start Script`
...
- whether `Mark Tree Group` constrained the bot correctly
...
- whether the bot stalled or recovered unexpectedly
