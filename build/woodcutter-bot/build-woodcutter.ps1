...
switch ($Server) {
    "Reason" {
        ...
        $deployDir = "C:\Users\jonez\.kreme\servers\Reason\scripts\woodcutter_bot"
    }
    "Near-Reality" {
        ...
        $deployDir = "C:\Users\jonez\.kreme\servers\Near-Reality\scripts\woodcutter_bot"
    }
}
...
if ($deployDir) {
    ...
    Copy-Item -LiteralPath $jarPath -Destination (Join-Path $deployDir ("woodcutter-bot-" + $serverSlug + "-latest.jar")) -Force
}
